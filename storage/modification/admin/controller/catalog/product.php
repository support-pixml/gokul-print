...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$this->load->model('extension/module/epiksel_fixedqty');

		if (!$this->model_extension_module_epiksel_fixedqty->getCheckDB()) {
			$this->model_extension_module_epiksel_fixedqty->install();
		}

		$this->model_extension_module_epiksel_fixedqty->update();

		$this->load->language('catalog/fixedqty');
		...
		/* Product FixedQty Begin */
		if (isset($this->request->post['product_fixedqty'])) {
			$data['product_fixedqties'] = $this->request->post['product_fixedqty'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['product_fixedqties'] = $this->model_catalog_product->getProductFixedQtys($this->request->get['product_id']);
		} else {
			$data['product_fixedqties'] = [];
		}
		/* Product FixedQty End */
