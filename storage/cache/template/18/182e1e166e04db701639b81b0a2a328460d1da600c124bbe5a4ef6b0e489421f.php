...
class __TwigTemplate_03e853b5bbfad60f3731f0efd0c7490148669396560e9c11a0d97c44df347804 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
            ...
            <video class=\"video-bg\" loop muted ";
                    // line 30
                    if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 30), "hasClass", [0 => "desktop"], "method", false, false, false, 30)) {
                        echo "autoplay";
                    }
                    echo " ";
                    if ((twig_get_attribute($this->env, $this->source, $context["grid_row"], "videoInline", [], "any", false, false, false, 30) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 30), "hasClass", [0 => "android"], "method", false, false, false, 30))) {
                        echo "autoplay";
                    }
                    echo " ";
                    if ((twig_get_attribute($this->env, $this->source, $context["grid_row"], "videoInline", [], "any", false, false, false, 30) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 30), "hasClass", [0 => "ios"], "method", false, false, false, 30))) {
                        echo "playsinline";
                    }
                    echo " data-src=\"";
...
";
    ...
    {
        return array (  148 => 35,  141 => 33,  123 => 30,  120 => 29,  117 => 28,  111 => 25,  108 => 24,  106 => 23,  103 => 22,  95 => 19,  86 => 16,  81 => 15,  77 => 14,  71 => 12,  67 => 11,  64 => 10,  58 => 7,  55 => 6,  53 => 5,  48 => 4,  44 => 3,  39 => 2,  37 => 1,);
    }
